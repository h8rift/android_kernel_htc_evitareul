...
struct early_suspend enrc2b_panel_onchg_suspender;
#endif
...
#ifdef CONFIG_HTC_ONMODE_CHARGING
static void enrc2b_panel_onchg_suspend(struct early_suspend *h)
{
	DISP_INFO_IN();
...
static void enrc2b_panel_onchg_resume(struct early_suspend *h)
{
	DISP_INFO_IN();
	unsigned i;
...
#ifdef CONFIG_HTC_ONMODE_CHARGING
	enrc2b_panel_onchg_suspender.suspend = enrc2b_panel_onchg_suspend;
	enrc2b_panel_onchg_suspender.resume = enrc2b_panel_onchg_resume;
	enrc2b_panel_onchg_suspender.level = EARLY_SUSPEND_LEVEL_DISABLE_FB;
	register_onchg_suspend(&enrc2b_panel_onchg_suspender);
#endif
#endif
